...
public class OrderApiController {
	...
	OrderApiController(OrderRepository repository, @Qualifier(value="orderAssembler") OrderAssembler assembler) {
	...
	@PostMapping
	ResponseEntity<OrderDto> newOrder(@RequestBody OrderDto orderDto) {
